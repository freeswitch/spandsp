...
for TEST in MRGN01 MRGN02 MRGN04 MRGN06a MRGN06b MRGN07 MRGN08
do
    run_tsb85_test
done
...
for TEST in OREN01 OREN02 OREN03 OREN04 OREN05 OREN06 OREN07 OREN08 OREN09
do
    run_tsb85_test
done

#for TEST in MRGX01 MRGX02 MRGX03 MRGX04 MRGX05 MRGX06 MRGX07 MRGX08
for TEST in MRGX02 MRGX03 MRGX04 MRGX05 MRGX06 MRGX07 MRGX08
do
    run_tsb85_test
done
...
for TEST in MTGN02 MTGN03 MTGN04 MTGN05 MTGN06 MTGN07 MTGN08 MTGN09 MTGN10
do
    run_tsb85_test
done
...
for TEST in MTGN21 MTGN22 MTGN23 MTGN24 MTGN25 MTGN26 MTGN27
do
    run_tsb85_test
done
...
for TEST in OTEN03 OTEN04 OTEN05
do
    run_tsb85_test
done

#for TEST in MTGX01 MTGX02 MTGX03 MTGX04 MTGX05 MTGX06 MTGX07 MTGX08
for TEST in MTGX01 MTGX02 MTGX03 MTGX04 MTGX05 MTGX06
do
    run_tsb85_test
done
